...
<aside class="login-aside active">
    ...
    <!-- Botón adicional para redirigir a v.prestamo.php -->
    <button onclick="window.location.href='Views/v.prestamo.php'" style="margin-top: 20px;">Ir al Formulario de Préstamo</button>
</aside>
</body>
</html>
