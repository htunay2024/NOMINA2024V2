<?php
class Intecap {
    private $mes, $anio, $montoPatronal, $idEmpleado, $idPoliza, $nombreCompleto;

    public function __construct($mes, $anio, $montoPatronal, $idEmpleado, $idPoliza, $nombreCompleto) {
        $this->mes = $mes; $this->anio = $anio; $this->montoPatronal = $montoPatronal; $this->idEmpleado = $idEmpleado; $this->idPoliza = $idPoliza; $this->nombreCompleto = $nombreCompleto;
    }
