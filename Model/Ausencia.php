...
class Ausencia {
    ...
    public function __construct($idSolicitud = null, $fechaSolicitud, $fechaInicio, $fechaFin, $motivo, $descripcion, $estado, $cuentaSalario, $descuento, $idEmpleado, $NombreCompleto = null) { $this->idSolicitud = $idSolicitud; $this->fechaSolicitud = $fechaSolicitud; $this->fechaInicio = $fechaInicio; $this->fechaFin = $fechaFin; $this->motivo = $motivo; $this->descripcion = $descripcion; $this->estado = $estado; $this->cuentaSalario = $cuentaSalario; $this->descuento = $descuento; $this->idEmpleado = $idEmpleado; $this->NombreCompleto = $NombreCompleto; }
    ...
    public function getCuentaSalario() { return $this->cuentaSalario; }
    ...
    public function setCuentaSalario($cuentaSalario) { $this->cuentaSalario = $cuentaSalario; }
