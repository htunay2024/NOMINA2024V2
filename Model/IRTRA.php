...
class IRTRA {
    private $idIRTRA, $mes, $anio, $montoPatronal, $idEmpleado, $idPoliza, $NombreCompleto;
    ...
    public function __construct($idIRTRA = null, $mes = null, $anio = null, $montoPatronal = null, $idEmpleado = null, $idPoliza = null, $NombreCompleto = null) {
        $this->idIRTRA = $idIRTRA; $this->mes = $mes; $this->anio = $anio; $this->montoPatronal = $montoPatronal; $this->idEmpleado = $idEmpleado; $this->idPoliza = $idPoliza; $this->NombreCompleto = $NombreCompleto;
    }

    public function getIdIRTRA() { return $this->idIRTRA; }
