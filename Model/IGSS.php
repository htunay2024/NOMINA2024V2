<?php
class IGSS {
    private $mes; private $anio; private $montoPatronal; private $montoLaboral; private $idEmpleado; private $idPoliza; private $nombreCompleto;

    public function __construct($mes, $anio, $montoPatronal, $montoLaboral, $idEmpleado, $idPoliza, $nombreCompleto) {
        $this->mes = $mes; $this->anio = $anio; $this->montoPatronal = $montoPatronal; $this->montoLaboral = $montoLaboral; $this->idEmpleado = $idEmpleado; $this->idPoliza = $idPoliza; $this->nombreCompleto = $nombreCompleto;
    }

    public function getMes() { return $this->mes; }
    public function getAnio() { return $this->anio; }
    public function getMontoPatronal() { return $this->montoPatronal; }
    public function getMontoLaboral() { return $this->montoLaboral; }
    ...
    public function setMontoPatronal($montoPatronal) { $this->montoPatronal = $montoPatronal; }
    public function setMontoLaboral($montoLaboral) { $this->montoLaboral = $montoLaboral; }
